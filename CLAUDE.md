...
├── superpowers/
│   ├── plans/
│   │   └── [2026-04-19-build-system-just.md](docs/superpowers/plans/2026-04-19-build-system-just.md) # Historical build system plan
│   └── specs/
│       └── [2026-04-19-build-system-design.md](docs/superpowers/specs/2026-04-19-build-system-design.md) # Historical build system spec
├── generated/
