...
├── superpowers/
│   ├── plans/
│   │   └── [2026-04-19-build-system-just.md](docs/superpowers/plans/2026-04-19-build-system-just.md) # Plan for Justfile build system migration
│   └── specs/
│       └── [2026-04-19-build-system-design.md](docs/superpowers/specs/2026-04-19-build-system-design.md) # Spec for Justfile build system migration
└── references/
