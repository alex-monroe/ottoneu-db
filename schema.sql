...
create table league_prices (
  ...
  price integer not null default 0 constraint chk_price_non_negative check (price >= 0),
...
create table transactions (
  ...
  team_name text,
  from_team text,
  salary integer constraint chk_salary_non_negative check (salary >= 0),
...
-- Stores manual surplus value adjustments per player per league per user
...
create table surplus_adjustments (
  ...
  unique(player_id, league_id, user_id)
);
