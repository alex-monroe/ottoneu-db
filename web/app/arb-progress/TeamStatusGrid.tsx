...
export default function TeamStatusGrid({
  ...
  if (teams.length === 0) {
    return (
      <section>
        <h2 className="text-xl font-semibold text-ink mb-3">Teams</h2>
        ...
        {teams.map((team) => {
          ...
          return (
            ...
            >
              ...
              {raisedAgainst != null && (
                <p className="text-xs text-ink-subtle mt-1 ml-4.5">
                  ${raisedAgainst} raised against
                </p>
              )}
              {spent != null && (
                <p className="text-xs text-ink-subtle mt-0.5 ml-4.5">
