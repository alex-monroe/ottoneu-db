...
export default function ConsentForm({
  ...
  return (
    <main id="main-content" className="flex min-h-[70vh] items-center justify-center bg-page px-4 py-10 sm:px-6">
      <div className="max-w-md w-full border border-line rounded-lg p-6 space-y-5">
        <header>
        ...
        <form action="/api/oauth/authorize" method="POST" className="flex gap-3">
          ...
          <button
            ...
            name="action"
            value="deny"
            className="flex-1 rounded-md border border-line-strong px-4 py-2 text-sm font-medium text-ink-muted hover:bg-sunken"
          >
            Deny
          </button>
          <button
