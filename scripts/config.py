...
PLAYOFF_TEAMS = _config["PLAYOFF_TEAMS"]
...
NFL_REGULAR_SEASON_WEEKS = _config["NFL_REGULAR_SEASON_WEEKS"]
ROSTER_SPOTS = _config["ROSTER_SPOTS"]
MIN_PLAYER_SALARY = _config["MIN_PLAYER_SALARY"]
FULL_SEASON_GAMES = _config["FULL_SEASON_GAMES"]
STARTING_LINEUP = _config["STARTING_LINEUP"]
FLEX_SLOTS = _config["FLEX_SLOTS"]
BENCH_DEPTH_PER_TEAM = _config["BENCH_DEPTH_PER_TEAM"]
FLEX_POSITIONS = _config["FLEX_POSITIONS"]
